            ...
            if (upgradeType == 1)
            {
                ...
                for (int i = 0; i < weaponSlots.Count; i++)
                {
                    ...
                    if (w != null && w.data == chosenWeaponUpgrade)
                    {
                        ...
                        upgradeOption.upgradeIcon.transform.Find("Upgrade Icon").GetComponent<Image>().sprite = chosenWeaponUpgrade.icon;
                ...
                if (chosenPassiveUpgrade != null)
                {
                    ...
                    for (int i = 0; i < passiveSlots.Count; i++)
                    {
                        ...
                        if (p != null && p.data == chosenPassiveUpgrade)
                        {
                            ...
                            upgradeOption.upgradeIcon.transform.Find("Upgrade Icon").GetComponent<Image>().sprite = chosenPassiveUpgrade.icon;
